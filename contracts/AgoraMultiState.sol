...
/**
 * @title AgoraMultiState
 *
 * @notice This is an abstract contract that implements internal AgoraHub state setting and validation.
 *
 * whenNotPaused: Either publishingPaused or Unpaused.
 * whenPublishingEnabled: When Unpaused only.
 */
abstract contract AgoraMultiState {
