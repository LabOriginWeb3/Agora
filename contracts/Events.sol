...
library Events {
     ...
     *
     * @param hub The AgoraHub contract address used.
     * @param timestamp The current block timestamp.
     */
    ...
    /**
     * @dev Emitted when the user wants to enable or disable follows in the `AgoraPeriphery`.
     *
    ...
    /**
     * @dev Emitted when the metadata associated with a profile is set in the `AgoraPeriphery`.
     *
