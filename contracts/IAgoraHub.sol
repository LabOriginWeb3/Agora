 ...
 *
 * @notice This is the interface for the AgoraHub contract, the main entry point for the Agora Protocol.
 * You'll find all the events and external functions, as well as the reasoning behind them here.
 */
interface IAgoraHub {
    /**
     * @notice Initializes the AgoraHub NFT, setting the initial governance address as well as the name and symbol in
     * the AgoraNFTBase contract.
     *
