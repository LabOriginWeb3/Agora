 ...
 *
 * @notice This is the standard interface for all Agora-compatible CollectModules.
 */
interface ICollectModule {
     ...
     * @param pubId The associated publication's AgoraHub publication ID.
     ...
     *
     * @param referrerProfileId The AgoraHub profile token ID of the referrer's profile (only different in case of mirrors).
     * @param collector The collector address.
     * @param profileId The token ID of the profile associated with the publication being collected.
     * @param pubId The AgoraHub publication ID associated with the publication being collected.
