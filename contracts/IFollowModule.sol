 ...
 *
 * @notice This is the standard interface for all Agora-compatible FollowModules.
 */
interface IFollowModule {
    /**
     * @notice Initializes a follow module for a given Agora profile. This can only be called by the hub contract.
     *
    ...
    /**
     * @notice Processes a given follow, this can only be called from the AgoraHub contract.
     *
     ...
     * only be called from the AgoraHub contract.
     *
