...
library ProfileTokenURILogic {
    ...
    function getProfileTokenURI(
        ...
        string memory handleWithAtSymbol = string(abi.encodePacked('@', _profileById[id].handle));
        return
            string(
                abi.encodePacked(
                    ...
                    Base64.encode(
                        abi.encodePacked(
                            ...
                            '","description":"',
                            handleWithAtSymbol,
                            ' - Agora profile","image":"data:image/svg+xml;base64,',
                            _getSVGImageBase64Encoded(handleWithAtSymbol, _profileById[id].imageURI),
                            ...
                            // '"},{"trait_type":"pubCount","value":"',
                            // Strings.toString(uint160(_profileById[id].pubCount)),
                            // '"},{"trait_type":"successRecommend","value":"',
                            // Strings.toString(_profileById[id].successRecommend),
                            // '"},{"trait_type":"successBet","value":"',
                            // Strings.toString(_profileById[id].successBet),
                            // '"},{"trait_type":"recommend","value":"',
                            // Strings.toString(_profileById[id].recommend),
                            // '"},{"trait_type":"bet","value":"',
                            // Strings.toString(_profileById[id].bet),
                            // '"},{"trait_type":"answers","value":"',
                            // Strings.toString(_profileById[id].answers),
                            // '"},{"trait_type":"questions","value":"',
                            // Strings.toString(_profileById[id].questions),
                            // '"},{"trait_type":"company","value":"',
                            // _profileById[id].company,
                            // '"},{"trait_type":"bio","value":"',
                            // _profileById[id].bio,
                            // '"},{"trait_type":"email","value":"',
                            // _profileById[id].email,
                            // '"},{"trait_type":"twitter","value":"',
                            // _profileById[id].twitter,
                            // '"},{"trait_type":"discord","value":"',
                            // _profileById[id].discord,
                            // '"},{"trait_type":"interests","value":"',
                            // _profileById[id].interests,
                            // '"},{"trait_type":"link","value":"',
                            // _profileById[id].link,
